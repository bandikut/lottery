...
public class LotteryWeeklyDrawData implements Serializable{
	...
	public LotteryWeeklyDrawData(int id, int year, int week, String date, int sevenM, String sevenP, int sixM, String sixP, int fiveM,
			String fiveP, int fourM, String fourP) {
		super();
		this.id = id;
		this.year = year;
		this.week = week;
